...
//Contactist.phpから検索したい情報取得
$name = $_POST['name'];

//検索用SQL文
$sql ="SELECT * FROM contactinfo WHERE name LIKE '%{$name}%' ORDER BY number DESC";
...
<header>
	...
	<div  style="position:relative;border-bottom:solid 3px darkBlue;height:80px;padding:3px;background-color:#fff;">
		...
		<h2 align="center" style="color:black;">お問い合わせ一覧</h2>
	</div>
	</header>
    	<br><br>
    	...
    	<table align="center">
    		<tr>
    			...
    			<td><input type="submit" value="名前検索"></td>
    		</tr>
    	</table>
    	</form>
    	...
    	<table align="center" border="0" class="main-table">
    		...
    		<?php }}else{ ?>
        		<tr><td colspan="6" align="center">該当するお問い合わせは１件もありません。</td></tr>
